...
kp = orb.detect(original_img, None)  # ORB (Oriented FAST and Rotated BRIEF)
# - один из алгоритмов используемых для создания дескриптора Подробности
# здесь: http://docs.opencv.org/3.0-beta/doc/py_tutorials/py_feature2d
# /py_orb/py_orb.html Другие алгоритмы для дескрипторов: SIFT
# http://aishack.in/tutorials/sift-scale-invariant-feature-transform
# -introduction/ SURF http://www.vision.ee.ethz.ch/~surf/eccv06.pdf Harris
...
secondary_img = cv2.drawKeypoints(original_img, kp, original_img,
